...
INSERT INTO `umkms` (`id`, `name`, `description`, `category`, `image`, `rating`, `operational_hours`, `contact_phone`, `contact_email`, `latitude`, `longitude`, `created_at`, `is_featured`) VALUES
(1, 'Mie Ayam Pangsit Buffet Tris', 'Mie Ayam Pangsit Terlaris Di Provinsi Bengkulu', 'Makanan & Minuman', 'uploads/umkms/68cbdde482190_1758191076.jpg', 4.5, 'Senin - Jumat: 08:00 - 17:00\nSabtu - Minggu: 09:00 - 15:00', '+62 812 3456 7890', 'info@mieayampangsitbuffettris.com', -3.79560000, 102.25920000, '2025-09-18 08:00:00', 0),
(2, 'Bakso Manunggal', 'Bakso Urat Terenak Di Bengkulu', 'Makanan & Minuman', 'uploads/umkms/68cbf9b5cc23a_1758198197.jpg', 5, 'Senin - Jumat: 08:00 - 17:00\nSabtu - Minggu: 09:00 - 15:00', '+62 812 3456 7890', 'info@baksomanunggal.com', -3.79740000, 102.25980000, '2025-09-18 12:23:17', 0),
...
INSERT INTO `wishlists` (`id`, `user_id`, `item_id`, `item_type`, `created_at`) VALUES
(3, 3, 8, 'umkm', '2025-09-24 02:43:37'),
(4, 3, 10, 'destination', '2025-09-24 02:43:45'),
(5, 3, 5, 'destination', '2025-09-24 02:44:04');
